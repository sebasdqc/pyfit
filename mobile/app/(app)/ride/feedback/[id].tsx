...
import { sendRideFeedback } from '../../../../lib/ridesApi'
import { captureMessage } from '../../../../lib/sentry'

// Espejo EXACTO de run/feedback/[id].tsx — el feedback post-sesión (RPE,
// sensación corporal, zonas de molestia, notas) es el mismo formulario para
// cualquier deporte de resistencia. Mismas claves i18n (compartidas con gym).
const RPE_OPTIONS = [
...
export default function RideFeedbackScreen() {
  ...
  async function handleFinish() {
    ...
    try {
      if (!isNaN(sessionId)) {
        await sendRideFeedback(sessionId, {
      ...
      captureMessage('ride-feedback POST failed — feedback not saved', 'warning')
  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        >
          <Text style={styles.eyebrow}>FEEDBACK · CICLISMO</Text>
