// Efecto de haz volumétrico (React Bits "LaserFlow", WebGL vía three.js),
// adaptado a TS. Uso EXCLUSIVO del Hero de LandingPage.tsx en desktop — se
// carga vía React.lazy (three pesa ~500-600kB) y solo se monta si el visitante
// no pidió prefers-reduced-motion. No es un componente genérico del panel.
