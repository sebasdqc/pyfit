// Diálogo modal accesible. Envuelve cualquier contenido en un backdrop con
// cierre por clic-fuera y delega en useDialogA11y el foco/Escape/scroll-lock.
// El contenido (cabecera, formulario, pie) lo aporta quien lo usa.
//
// Uso típico:
//   <Dialog onClose={cerrar} labelledBy="titulo-x" className="… max-w-lg …">
...
export function Dialog({
  ...
  children,
  className = '',
  backdropClassName = 'bg-brand-deep/40',
  center = true,
}: {
  onClose: () => void
