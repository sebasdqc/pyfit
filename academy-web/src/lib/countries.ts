// Lista de países (estados soberanos + algunos territorios habituales), en
// español y orden alfabético, para el selector de "Datos personales". Es una
// copia deliberada de mobile/lib/countries.ts — apps distintas, sin paquete
// compartido — mantener ambas en sync si se agrega/quita un país.
