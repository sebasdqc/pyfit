      ...
      <div className="flex flex-wrap gap-2">
        {ESCENARIOS.map((e) => (
          <button
            ...
            className="rounded-full border border-surface-border bg-surface px-3.5 py-2.5 text-xs font-semibold text-ink-soft transition-colors hover:border-accent hover:text-accent"
          >
            {e.label}
          </button>
        ))}
