...
INSTALLED_APPS = [
    ...
    'endurance',
    # Motor de ciclismo — Fase 2 del plan running+ciclismo: ciencia
    # (training_science_cycling.py), espejo del F0 de ai_running. Ancla
    # FC+RPE, potencia opcional. Sin endpoints todavía.
    'ai_cycling',
    # Modelos de ciclismo (CyclistProfile/RidePlan/PlannedRide/RideSession) —
    # Fase 3, espejo de 'runs'. Sin RidePoint (tracking GPS) ni motor
    # adaptativo todavía — solo el esquema de datos.
    'cycling',
    'devices',
