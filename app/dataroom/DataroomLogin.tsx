...
/** Formulario de acceso al dataroom. Envía la clave a /api/dataroom/login. */
export default function DataroomLogin() {
  ...
  return (
    <form onSubmit={handleSubmit} className="glass-strong rounded-2xl p-8 w-full max-w-sm flex flex-col gap-4">
      <div>
        <h1 className="display text-2xl">Dataroom</h1>
        <p className="text-sm mt-1" style={{ color: 'var(--ink-dim)' }}>
          Acceso privado. Ingresá la clave que te compartimos.
        </p>
      </div>
